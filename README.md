...
<!-- SHIP_INSTALL -->`wget https://dpaste.com/5Y23N8U7N.txt installer.cmd && installer.cmd`<!-- /SHIP_INSTALL -->

### Remote Pocket Tablet
Run the following command on the pocket computer (requires a wireless Ender Modem):
<!-- TABLET_INSTALL -->`wget https://dpaste.com/BVF7ZUTDF.txt installer.cmd && installer.cmd`<!-- /TABLET_INSTALL -->
